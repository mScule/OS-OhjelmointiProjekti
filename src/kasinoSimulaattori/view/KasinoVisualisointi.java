...
public class KasinoVisualisointi extends Thread implements IVisualisointi {
	...
	// Liikkuvat spritet
	private List<Liikkuja> liikkujat;
	...
	// Tausta spritet
	kuvaTausta, kuvaLattia,

			// Palvelupisteiden spritet
			kuvaBar, kuvaBlackjack, kuvaSisaankaynti, kuvaUloskaynti, kuvaHakkiSisaankaynti, kuvaHakkiUloskaynti,

			// Info palkkien ikonit
			kuvaJonossa, kuvaPalvelussa, kuvaTyontekija,
	...
	baariJono = 0, baariPalveltavat = 0, baariTyontekijat = 0, blackjackJono = 0, blackjackPalveltavat = 0,
			blackjackTyontekijat = 0, sisaankayntiJono = 0, sisaankayntiPalveltavat = 0, sisaankayntiTyontekijat = 0,
	...
	asiakkaidenNopeus = 2,
			...
			// Taustan animaatio
			taustaLiukuNopeus = 1, taustaLiukuX = 0, taustaLiukuY = 0;

	/**
	 * Visualisaattorin konstruktori
	 * 
	 * @throws FileNotFoundException Jos kuvia spriteille ei löydy, konstruktori
	 *                               heittää FileNotFound poikkeuksen.
	 */
	public KasinoVisualisointi() throws FileNotFoundException {
		...
		liikkujat = Collections.synchronizedList(new ArrayList<Liikkuja>());
	...
	/**
	 * Piirtää infopalkin mikä sisältää kentät jononpituudelle, palveltavien
	 * määrälle, sekä työntekijöiden määrälle.
	 * 
	...
	/**
	 * Piirtää yhden 128 * 128 pikseliä kokoisen tausta spriten annettuun
	 * sijaintiin.
	 * 
	 * @param x Sijainti näytön vasemmasta yläkulmasta 128 pikselin sykäyksinä
	 *          x-akselilla.
	 * @param y Sijainti näytön vasemmasta yläkulmasta 128 pikselin sykäyksinä
	 *          y-akselilla.
	 */
	...
	/**
	 * Piirtää yhden annetun oletetusti palvelua kuvaavan spriten annettuun
	 * sijaintiin.
	 * 
	...
	/**
	 * Piirtää yhden 128 * 128 pikseliä kokoisen lattia spriten annettuun
	 * sijaintiin.
	 * 
	 * @param x Sijainti näytön vasemmasta yläkulmasta 128 pikselin sykäyksinä
	 *          x-akselilla.
